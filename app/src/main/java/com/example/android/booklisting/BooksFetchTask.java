...
public class BooksFetchTask extends AsyncTask<String, Void, ArrayList<Book>> {

    public MainActivity mMainActivity;

    private final String LOG_TAG = BooksFetchTask.class.getSimpleName();

    private final Context mContext;

    public BooksFetchTask(Context context, MainActivity mainActivity) {
        mContext = context;
    ...
    private ArrayList<Book> getBookDataFromJson(String booksJsonStr)
        ...
        try {
            ...
            Log.d(LOG_TAG, "BooksFetchTask Complete.");
